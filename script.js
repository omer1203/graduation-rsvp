...
document.getElementById('rsvpForm').addEventListener('submit', (event) => { // in the .addEventListener(event, callback), the following is the callback event denoted by event

    event.preventDefault(); // prevents the form from reloadig the page
